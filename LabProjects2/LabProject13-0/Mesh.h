...
//130
/*CHeightMapGridMesh 클래스의 베이스 클래스를 CMeshTextured로 변경한다. 지형의 색상을 텍스쳐 매핑을 사용하여 결정하기 위하여 지형 메쉬의 각 정점은 텍스쳐 좌표를 갖는다.*/
class CHeightMapGridMesh : public CMeshTextured
{
protected:
