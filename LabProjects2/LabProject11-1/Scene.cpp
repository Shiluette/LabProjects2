...
void CScene::BuildObjects(ID3D11Device *pd3dDevice)
{
	...
	pGreenInstancedObjectsShader->BuildObjects(pd3dDevice, GetTerrain(), pGreenMaterial, 1);
	m_ppShaders[2] = pGreenInstancedObjectsShader;

	CInstancingShader *pBlueInstancedObjectsShader = new CInstancingShader();
	pBlueInstancedObjectsShader->CreateShader(pd3dDevice);
	pBlueInstancedObjectsShader->BuildObjects(pd3dDevice, GetTerrain(), pBlueMaterial, 2);
	m_ppShaders[3] = pBlueInstancedObjectsShader;
