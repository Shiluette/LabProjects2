...
// LabProject07-3은 깊이버퍼만 생성한 오리지날 따라하기 코드
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_LABPROJECT073, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LABPROJECT073);
